...
require (
	github.com/saichler/l8bus v0.0.0-20251219172916-f556c16cca9f
	github.com/saichler/l8pollaris v0.0.0-20251219180049-f0966036ad7a
	...
	github.com/saichler/probler v0.0.0-20251218225610-d9579e8216f6
