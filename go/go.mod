...
require (
	...
	github.com/saichler/l8pollaris v0.0.0-20251218214634-dce5e4d7d6e2
	...
	github.com/saichler/probler v0.0.0-20251218180906-201bacf2e063
...
require (
	...
	github.com/saichler/l8orm v0.0.0-20251218214225-13158be209d4 // indirect
